...
{
    /**
     * Language file processing callback. Converts Joomla messages into October CMS ones
     *
    ...
    public static function processLanguageIniFile($filename, $strings)
    {
        ...
        {
            $v = str_replace('Joomla!', 'October CMS', $v);
            $v = str_replace('Joomla', 'October CMS', $v);
            $v = str_replace('configuration.php', 'database.php', $v);
