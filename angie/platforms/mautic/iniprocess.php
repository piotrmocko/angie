...
{
    /**
     * Language file processing callback. Converts Joomla messages into Mautic ones
     *
    ...
    public static function processLanguageIniFile($filename, $strings)
    {
        ...
        {
            $v = str_replace('Joomla!', 'Mautic', $v);
            $v = str_replace('Joomla', 'Mautic', $v);
            $v = str_replace('configuration.php', 'app/config/local.php', $v);
