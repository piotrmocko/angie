...
echo $this->loadAnyTemplate('steps/steps', array('helpurl' => 'https://www.akeebabackup.com/documentation/solo/angie-magento-setup.html'));
?>
		...
		<div class="span6">
			...
			<div class="form-horizontal">
				<div class="control-group">
					<label class="control-label" for="adminurl">
						<?php echo AText::_('SETUP_LBL_ADMINURL'); ?>
					</label>
					<div class="controls">
						<input type="text" id="adminurl" name="adminurl" value="<?php echo $this->stateVars->adminurl ?>" />
						<span class="help-tooltip icon-question-sign" data-toggle="tooltip" data-html="true" data-placement="top"
							  title="<?php echo AText::_('SETUP_LBL_ADMINURL_HELP') ?>"></span>
					</div>
				</div>
            </div>
		</div>
