...
{
    /**
     * Language file processing callback. Converts Joomla messages into Grav ones
     *
    ...
    public static function processLanguageIniFile($filename, $strings)
    {
        ...
        {
            $v = str_replace('Joomla!', 'Grav', $v);
            $v = str_replace('Joomla', 'Grav', $v);
            $v = str_replace('configuration.php', 'user/config/system.yaml', $v);
